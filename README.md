The goal in this Project is to get a json with employee data in each json and to seperate the the big json into smalls json that will be pushed into mongo db
